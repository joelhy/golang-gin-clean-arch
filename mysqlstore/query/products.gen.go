...
func newProduct(db *gorm.DB, opts ...gen.DOOption) product {
	...
	_product.PriceAmount = field.NewInt64(tableName, "price_amount")
	_product.Currency = field.NewString(tableName, "currency")
	_product.Stock = field.NewUint32(tableName, "stock")
	_product.Status = field.NewString(tableName, "status")
	_product.Version = field.NewUint64(tableName, "version")
...
func (p *product) updateTableName(table string) *product {
	...
	p.PriceAmount = field.NewInt64(table, "price_amount")
	p.Currency = field.NewString(table, "currency")
	p.Stock = field.NewUint32(table, "stock")
...
func (p *product) fillFieldMap() {
	...
	p.fieldMap["price_amount"] = p.PriceAmount
