...
func newSession(db *gorm.DB, opts ...gen.DOOption) session {
	...
	_session.Rotation = field.NewUint64(tableName, "rotation")
	_session.ExpiresAt = field.NewTime(tableName, "expires_at")
	_session.RevokedAt = field.NewTime(tableName, "revoked_at")
	_session.ReuseDetectedAt = field.NewTime(tableName, "reuse_detected_at")
...
type session struct {
	...
	ID              field.String
	UserID          field.Uint64
	Rotation        field.Uint64
	ExpiresAt       field.Time
	RevokedAt       field.Time
	ReuseDetectedAt field.Time
...
func (s *session) updateTableName(table string) *session {
	...
	s.Rotation = field.NewUint64(table, "rotation")
	s.ExpiresAt = field.NewTime(table, "expires_at")
	s.RevokedAt = field.NewTime(table, "revoked_at")
	s.ReuseDetectedAt = field.NewTime(table, "reuse_detected_at")
...
func (s *session) fillFieldMap() {
	...
	s.fieldMap["rotation"] = s.Rotation
	s.fieldMap["expires_at"] = s.ExpiresAt
	s.fieldMap["revoked_at"] = s.RevokedAt
	s.fieldMap["reuse_detected_at"] = s.ReuseDetectedAt
