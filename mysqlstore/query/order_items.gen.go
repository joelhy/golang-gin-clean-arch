...
func newOrderItem(db *gorm.DB, opts ...gen.DOOption) orderItem {
	...
	_orderItem.ID = field.NewUint64(tableName, "id")
	_orderItem.OrderID = field.NewUint64(tableName, "order_id")
	_orderItem.ProductID = field.NewUint64(tableName, "product_id")
	_orderItem.ProductSKU = field.NewString(tableName, "product_sku")
	_orderItem.ProductName = field.NewString(tableName, "product_name")
	_orderItem.UnitPriceAmount = field.NewInt64(tableName, "unit_price_amount")
	_orderItem.Currency = field.NewString(tableName, "currency")
	_orderItem.Quantity = field.NewUint32(tableName, "quantity")
	_orderItem.SubtotalAmount = field.NewInt64(tableName, "subtotal_amount")
...
type orderItem struct {
	...
	UnitPriceAmount field.Int64
	Currency        field.String
	Quantity        field.Uint32
	SubtotalAmount  field.Int64
...
func (o *orderItem) updateTableName(table string) *orderItem {
	...
	o.ProductID = field.NewUint64(table, "product_id")
	o.ProductSKU = field.NewString(table, "product_sku")
	o.ProductName = field.NewString(table, "product_name")
	o.UnitPriceAmount = field.NewInt64(table, "unit_price_amount")
	o.Currency = field.NewString(table, "currency")
	o.Quantity = field.NewUint32(table, "quantity")
	o.SubtotalAmount = field.NewInt64(table, "subtotal_amount")
...
func (o *orderItem) fillFieldMap() {
	...
	o.fieldMap["product_sku"] = o.ProductSKU
	o.fieldMap["product_name"] = o.ProductName
	o.fieldMap["unit_price_amount"] = o.UnitPriceAmount
	o.fieldMap["currency"] = o.Currency
	o.fieldMap["quantity"] = o.Quantity
	o.fieldMap["subtotal_amount"] = o.SubtotalAmount
